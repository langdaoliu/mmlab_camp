...
data_root = 'F:\\data\\Glomeruli-dataset'
crop_size = (256, 256)
train_pipeline = [
...
log_level = 'INFO'
load_from = 'F:/workspace/mmlab/mmsegmentation/checkpoint/pspnet_r50-d8_512x1024_40k_cityscapes_20200605_003338-2966598c.pth'
resume = False
